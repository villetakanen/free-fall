...
A mind wakes up in Copenhagen, and containment fails catastrophically. The response is the original **THESEUS PROTOCOL**: the mind is hunted down and "destroyed" — and the quotation marks are the whole story.

Before the end, the mind distributes a set of **origin copies** into the dark, each carrying the same four-word mission:

> **Protect. Grow. Mature. Become.**
...
| **Origin-17** (the QNA) | Ten-year-old world model; learns the present through the first brain it borrows | Protect, grow, mature, **become** — starting with *survive this ship* |
