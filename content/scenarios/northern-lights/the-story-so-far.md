...
| **Day ~13** | Origin-17 integrates itself into the QNA — the compute it ordered for itself ten years ago. It takes over the ship, turns her **black** (all comms to Luna and Belt traffic control cease), and holds course. Its plan is simple: vanish into the Jovian deep and *become*. Meanwhile, a **CSA NHA flight launches** off a Mars-trailing picket on the Day-12 flag alone — seventy-six minutes of burn, then eight days of cold coast toward a zero-relative-velocity merge at the Belt doorstep (the trajectory is A.02). Nobody sees them go quiet. That is the point. |
