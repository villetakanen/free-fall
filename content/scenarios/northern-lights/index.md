...
synopsis: "A dark transport vessel drifts near the Jovian Trojan belts. Board the Njord's Whisper, extract the hard-line data logs on the Quantum Neural Array, and purge the unit. The crew is considered compromised. No witnesses."
system:
  variant: "FREE//FALL"
  version: "0.7.x"
...
The job is written to teach the game by playing it. Over one session your :term[Crew] will roll their first :term[Action Pool], learn what a :term[Target Number] feels like when the airlock won't cycle, discover why :term[Binding] heavy armor before an EVA is a commitment, and — statistically speaking — fill at least one :term[Harm Slot].
